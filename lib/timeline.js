...
(function () {
  ...
  function build(opts, resolve) {
    ...
    var restBtn = button('estimate the rest', {'data-x': 'rest', 'class': 'tl-btn',
      'title': 'lay a first guess over everything AFTER this line -- each piece given '
    ...
    function spreadRest() {
      ...
      say(((N - from) === 1 ? "the one piece after this" : (N - from) + " pieces after this")
          + " estimated afresh; nothing to the left of it moved");
    }
    ...
    function paintEdit() {
      ...
      restBtn.disabled = busy || restFrom() >= N;
